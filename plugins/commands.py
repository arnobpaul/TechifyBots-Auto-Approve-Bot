...
async def start_cmd(client, message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘs ⇆', url=f"https://telegram.me/Anjakakallaleech_bot?startgroup=true&admin=invite_users")],
            [InlineKeyboardButton('ℹ️ ᴀʙᴏᴜᴛ', callback_data='about'),
             InlineKeyboardButton('🛠️ ʜᴇʟᴘ', callback_data='help')],
            [InlineKeyboardButton('⇆ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ᴄʜᴀɴɴᴇʟ ⇆', url=f"https://telegram.me/Anjakakallaleech_bot?startchannel=true&admin=invite_users")]
            ])
        )
